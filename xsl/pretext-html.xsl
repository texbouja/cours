...
<xsl:template name="cpgem-link">
    <a class="cpgem-link" href="https://texbouja.github.io/cpgem" title="CPGEM">
        <img class="logo" src="https://texbouja.github.io/cpgem/assets/img/favicons/favicon.png" alt="CPGEM logo"/>
    </a>
</xsl:template>
